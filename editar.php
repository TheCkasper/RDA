...
$id = $_GET['id'];
$sql = $conn->query("SELECT * FROM alumno WHERE id = '$id'");
...
?>
            ...
            <input type="number" class="form-control" name="cui" value="<?php echo $dat -> cui; ?>"placeholder="ingrese el numero de identificación del estudiante">
         

         
            <label  class="form-label">FECHA DE NACIMIENTO</label>
            <input type="date" class="form-control" name="fecha_n" value="<?php echo $dat -> fecha_n; ?>" placeholder="ingrese la fecha de nacimiento del estudiante">
            ...
            <input type="text" class="form-control" name="direccion" value="<?php echo $dat -> direccion; ?>"placeholder="ingrese el la direccion del estudiante">
          

          
            <label  class="form-label">GRADO</label>
            <input type="text" class="form-control" name="grado" value="<?php echo $dat -> grado; ?>"placeholder="ingrese el grado de estudio del estudiante">
         

          
            <label  class="form-label">CARERRA</label>
            <input type="text" class="form-control" name="carrera" value="<?php echo $dat -> carrera; ?>"placeholder="ingrese la carrera del estudiante">
            </div>
