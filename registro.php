    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" name="cui" placeholder="ingrese el numero de identificación del estudiante">
          </div>

          <div class="mb-3">
            <label  class="form-label">FECHA DE NACIMIENTO</label>
            <input type="date" class="form-control" name="fecha_n" placeholder="ingrese la fecha de nacimiento del estudiante">
          </div>

          <div class="mb-3">
            <label  class="form-label">TELEFONO</label>
            <input type="number" class="form-control" name="telefono" placeholder="ingrese el numero de telefono del estudiante">
          </div>

          <div class="mb-3">
            <label  class="form-label">CORREO</label>
            <input type="email" class="form-control" name="correo" placeholder="ingrese el correo del estudiante">
          </div>

          <div class="mb-3">
            <label  class="form-label">DIRECCION</label>
            <input type="text" class="form-control" name="direccion" placeholder="ingrese el la direccion del estudiante">
          </div>

          <div class="mb-3">
            <label  class="form-label">GRADO</label>
            <input type="text" class="form-control" name="grado" placeholder="ingrese el grado de estudio del estudiante">
          </div>

          <div class="mb-3">
            <label  class="form-label">CARERRA</label>
            <input type="text" class="form-control" name="carrera" placeholder="ingrese la carrera del estudiante">
          </div>
